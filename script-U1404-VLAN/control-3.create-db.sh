...
GRANT ALL PRIVILEGES ON nova.* TO 'nova'@'$HOST_NAME' IDENTIFIED BY '$MYSQL_PASS';
...
GRANT ALL PRIVILEGES ON glance.* TO 'glance'@'$HOST_NAME' IDENTIFIED BY '$MYSQL_PASS';
#
...
GRANT ALL PRIVILEGES ON keystone.* TO 'keystone'@'$HOST_NAME' IDENTIFIED BY '$MYSQL_PASS';
#
...
GRANT ALL PRIVILEGES ON cinder.* TO 'cinder'@'$HOST_NAME' IDENTIFIED BY '$MYSQL_PASS';
#
...
GRANT ALL PRIVILEGES ON neutron.* TO 'neutron'@'$HOST_NAME' IDENTIFIED BY '$MYSQL_PASS';
#
FLUSH PRIVILEGES;
EOF
#
